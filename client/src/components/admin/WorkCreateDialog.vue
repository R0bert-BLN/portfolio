...
import type { CreateEducation, WorkRequest } from '@/types/types.ts'
import { computed, reactive, ref } from 'vue'
import { format } from 'date-fns'

interface Emits {
    (e: 'close'): void
    (e: 'create', payload: WorkRequest): void
}
...
<template>
    <v-card rounded="lg">
        <v-card-title class="text-center mt-5 mb-10">
            <span class="text-[#2475c8] text-[30px] font-bold">Create Work</span>
        </v-card-title>
